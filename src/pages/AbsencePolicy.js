...
const AbsencePolicy = () => {
  ...
  const visibleCount = 7; // number of items before 'View More'
    ...
    <Container fluid className="absence-policy-fluid g-0">
      <Container className="absence-policy">
        <div className="absence-policy-container">
          <div className="absence-policy-box scrollable-box">
            <div className="d-flex justify-content-center align-items-center">
              <p className="page-heading">Absence & Attendance Policy</p>
            </div>

            <ul>
              {absencePoints
                .slice(0, viewMore ? absencePoints.length : visibleCount)
                .map((point, index) =>
                  typeof point === 'string' ? (
                    <li key={index}>
            ...
            {!viewMore && absencePoints.length > visibleCount && (
              <button
